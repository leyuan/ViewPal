        ...
        <div class="headline">
            <div class="container">
                ...
                <div class="headline-sub-title">
                    <h3>Powerful Features for Relationship Building</h3>
                </div>
            </div>
        </div>
    </div>  
                    ...
                    <div class="features-body-two-element col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div>
                            ...
                            <div class="element-intro font-small">
                                <p>
                                    ViewPal gives you the data you need to make smart decisions about your business. You’ll get data on 
                                    your revenue and conversion rates, reporting on who is buying, and analytics on your most purchased 
                                    content and popular price points. 
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="lower-body">
    <div class="features-cta">
        ...
        <div class="features-cta-btn-row">
            ...
            <a href="<?php echo base_url()."whyviewpal"?>" class="btn cta-btn btn-login">NO, I NEED TO KNOW WHY CHOOSING VIEWPAL</a>       
        </div>
    </div>
</section>
